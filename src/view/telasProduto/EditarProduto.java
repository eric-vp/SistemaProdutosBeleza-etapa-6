...
public class EditarProduto extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            produtoEditado.setId(this.produto.getId());
            produtoEditado.setNome(nome);
            produtoEditado.setMarca(marca);
            produtoEditado.setDescricao(descricao);
            produtoEditado.setPreco(preco);
            produtoEditado.setQtdEstoque(qtdEstoque);

            Utils utils = new Utils();
            int opcao = utils.confirmar("Deseja mesmo editar esse produto?");
